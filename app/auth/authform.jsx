...
export default function AuthPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (isLogin) {
      await handleLogin(email, password, router, rememberMe);
    } else {
    ...
    <div className="container-fluid vh-100 p-0 overflow-hidden">
      <div className="row h-100 m-0">
        <div className="col-12 col-lg-6 d-flex flex-column justify-content-center position-relative p-4 p-md-5">
          ...
          {/* Form container */}
          <div className="mx-auto" style={formStyle}>
            <div className="position-relative overflow-hidden">
              ...
              >
                {/* Sign Up Form */}
                <div className="w-75 flex-shrink-0 me-4" style={formStyle}>
                  <div className="mb-4">
                ...
                {/* Login Form */}
                <div className="w-100 flex-shrink-0" style={formStyle}>
                  <div className="mb-4">
